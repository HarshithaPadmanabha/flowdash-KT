  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    if (!API_BASE_URL) {
      toast({
        ...
        description:
          "API URL is not set. Add VITE_API_BASE_URL to your .env file (e.g. VITE_API_BASE_URL=http://localhost:4000/api) and restart the dev server.",
        variant: "destructive",
      });
      return;
    }
    ...
    setLoginTime(loginTime);
      ...
      const message =
        err?.message ||
        "Something went wrong. Check that the backend is running and VITE_API_BASE_URL points to it.";
      toast({
        title: "Login Failed",
        description: message,
        variant: "destructive",
